...
import { idlFactory } from './aio-deck-backend.did.js';
export { idlFactory } from './aio-deck-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AIO_DECK_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./aio-deck-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the aio-deck-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./aio-deck-backend.did.js")._SERVICE>}
 */
export const aio_deck_backend = createActor(canisterId);
