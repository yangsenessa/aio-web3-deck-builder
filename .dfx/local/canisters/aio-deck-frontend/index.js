...
import { idlFactory } from './aio-deck-frontend.did.js';
export { idlFactory } from './aio-deck-frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AIO_DECK_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./aio-deck-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the aio-deck-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./aio-deck-frontend.did.js")._SERVICE>}
 */
export const aio_deck_frontend = createActor(canisterId);
